...
3. Identify 5-10 highly relevant search keywords that users might search for if experiencing this issue.
4. Provide a very brief overall summary (reusableKbSummary).
5. Return ONLY a raw JSON object. Do not wrap it in markdown code blocks (\`\`\`).
