    ...
    <div className="fixed inset-0 bg-slate-950/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-scale-up">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-850/80 space-y-1.5">
          ...
          {/* Alert check */}
          {error && (
            <div className="p-3 bg-red-950/40 border border-red-900 text-red-200 text-xs rounded-lg flex items-center gap-2">
          ...
          <div>
            ...
            <select
              ...
              className="block w-full px-3 py-2.5 mt-2 border border-slate-800 rounded-xl bg-slate-950 text-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
            >
          ...
          <div className="flex justify-end gap-3 pt-3 border-t border-slate-850">
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold rounded-xl shadow-lg active:scale-95 transition-all duration-150"
            >
              Confirm Assignment
            </button>
          </div>
